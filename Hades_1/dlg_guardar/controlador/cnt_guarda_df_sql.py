...
Versión 1.0.1: Desactiva la opción de guardar en SQL la tabla
'Implantaciones'. Estos datos no se emplearán al abrir la SQL con los datos
guardados e importar únicamente la configuración de las implantaciones y 
mantener los datos importados previamente en la applicación.
"""
...
class CntGuardaDFSQL:
    ...
    def df_sqlite(self):
        ...
        if df_proyecto.empty or df_grupos.empty or\
